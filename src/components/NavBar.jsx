    ...
    <nav className="mt-5">
      <div className="navbar bg-base-100">
        <div className="navbar-start">
          ...
          <a className="btn btn-ghost text-xl sm:text-base lg:text-3xl font-bold">
            Book Vibe
          </a>
        </div>
        ...
        <div className="navbar-end space-x-4">
          <a className="btn bg-green-500 font-semibold text-white text-lg">
            Sign In
          </a>
          <a className="btn bg-sky-500 font-semibold text-white text-lg">
            Sign Up
          </a>
        </div>
      </div>

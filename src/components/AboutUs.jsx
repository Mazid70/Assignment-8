    ...
    <div className="container flex items-center justify-center bg-gray-100">
      <div className="container px-8 py-12  shadow-md rounded-lg">
        ...
        <p className="text-gray-700 mb-8">
          Welcome to Book Vibe, where reading meets passion! At Book Vibe, we are
          dedicated to providing a vibrant platform for book lovers to explore,
          discover, and connect with their favorite reads.
        </p>
          <div className="mt-4 text-gray-700">
            ...
            <p className="mt-2">
              ...
              discussions, and discover the magic of storytelling with Book
              Vibe.
            </p>
            ...
            <div className="mt-8 border-t pt-6 border-gray-200">
              ...
              <ul className="list-disc list-inside text-gray-700">
                ...
                <li>
                  Access exclusive content and deals with our membership
                  program.
                </li>
              </ul>
            </div>
